...
SELECT COUNT(*) FROM PUBLIC.T2K_CAREER;
...
TRUNCATE TABLE PUBLIC.T2K_NATIONALITY;
TRUNCATE TABLE PUBLIC.T2K_SKILL;
...
DROP PROCEDURE IF EXISTS create_careers;
DROP TABLE PUBLIC.T2K_CAREER;

select * from T2K_NATIONALITY
